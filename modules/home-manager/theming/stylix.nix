...
in {
  stylix = {
    ...
    base16Scheme = {
      ...
      base05 = "e2e2e2"; # Default Foreground, Caret, Delimiters, Operators
      ...
      base0A = "f5c343"; # Classes, Markup Bold, Search Text Background
      ...
      base0D = "5c9ee8"; # Functions, Methods, Attribute IDs, Headings
      base0E = "b675f1"; # Keywords, Storage, Selector, Markup Italic, Diff Changed
      base0F = "d074b0"; # Deprecated, Opening/Closing Embedded Language Tags, e.g. <?php ?>
    };
  };
}
