...
if [[ $1 == "showsetsorpanels" ]]; then
	if [ -f "${states}/showsetsorpanels" ]; then
...
elif [[ $1 == "showslimetoggle" ]]; then
	if [ -f "${states}/showslimetoggle" ]; then
...
elif [[ $1 == "showhwmontoggle" ]]; then
	if [ -f "${states}/showhwmontoggle" ]; then
